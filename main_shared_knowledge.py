...
from diffusion_shared_knowledge import GaussianDiffusionTrainer, GaussianDiffusionSampler
...
flags.DEFINE_float('loss_portion', 0.1, help='portion of shared knowledge')
...
def train():
    ...
    trainer = GaussianDiffusionTrainer(
        ...
        FLAGS.num_class, FLAGS.cfg, FLAGS.cb, FLAGS.tau, weight, FLAGS.finetune, FLAGS.shared_knowledge, FLAGS.shared_portion, FLAGS.shared_resolution).to(device)
