...
from diffusion_original_truncate import GaussianDiffusionTrainer, GaussianDiffusionSampler
...
def eval():
    ...
    with open(os.path.join(FLAGS.logdir,  'res_ema_{}.txt'.format(FLAGS.sample_name)), 'a+') as f:
        f.write("Settings: NUM:{} EPOCH:{}, OMEGA:{}, METHOD:{}, FID_CACHE: {} \n" .format (FLAGS.num_images, FLAGS.ckpt_step, FLAGS.omega,FLAGS.sample_method, FLAGS.fid_cache))
